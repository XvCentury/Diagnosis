...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const headHeight = common_vendor.ref(0);
    const setNavSize = () => {
      const {
        statusBarHeight
      } = common_vendor.index.getSystemInfoSync();
      console.log(statusBarHeight);
      headHeight.value = statusBarHeight;
    };
    const onNav2Tap = (e) => {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        i: common_vendor.s("margin-top:" + headHeight.value * 2 + "px;")
      });
    };
  }
};
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/STUDIO/Git/GitHub/Diagnosis/Diagnosis/project/pages/index/index.vue"]]);
